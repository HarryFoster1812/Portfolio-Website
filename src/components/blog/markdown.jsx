            ...
            components={{
              ...
              p({ children }) {
                ...
                if (
                  ...
                  /\ garder à l'esprit que le code est sensible à la casse et qu'il faut respecter la casse des lettres dans les noms de fichiers et les chemins d'accès aux fichiers..(mp4|webm|ogg)$/i.test(
                    child.props.src
                  )
                ) {
                  return (
