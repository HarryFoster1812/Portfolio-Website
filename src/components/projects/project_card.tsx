...
export const ProjectCard = ({project} : {project: Project}) => {
    return (
        <>
            <div className="card my-10 w-7/10 md:w-4/6  bg-blackrounded-2xl overflow-hidden shadow-2xl backdrop-blur-lg transform-style-preserve-3d perspective-[1000px] transition-all ease-in-out duration-500 hover:translate-y-[-10px] hover:rotate-x-5 hover:rotate-y-[-5px] hover:shadow-[0_15px_40px_rgba(0,_255,_255,_0.5)] animate__animated animate__fadeInUp  z-1">
                ...
                <div className="p-6 relative">
                    ...
                    <div className="flex justify-evenly items-center">
                        <Link href={`https://github.com/HarryFoster1812/${project.link}`} target="_blank" rel="noopener noreferrer" className="w-15 py-3 px-6 bg-gradient-to-br from-cyan-400 to-pink-500 text-black no-underline rounded-xl font-bold uppercase tracking-wide flex items-center justify-center transition-all duration-300 ease-in-out hover:translate-y-[-3px] hover:shadow-[0_10px_20px_rgba(0,_255,_255,_0.4)]">
                        ...
                        <Link href={`/projects/${project.link}`} className="inline-block py-3 px-6 bg-gradient-to-br from-cyan-400 to-pink-500 text-black no-underline rounded-xl font-bold uppercase tracking-wide relative transition-all duration-300 ease-in-out hover:translate-y-[-3px] hover:shadow-[0_10px_20px_rgba(0,_255,_255,_0.4)]">
                             See more
                        </Link>
                    </div>
                </div>
